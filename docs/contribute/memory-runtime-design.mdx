...
The provider, automatic, and local background reference slices are implemented.
...
provider bridges, OSS adapters, prompt-cache coordination,
...
maintainer lifecycle. Provider factories and adapters remain staged work.
